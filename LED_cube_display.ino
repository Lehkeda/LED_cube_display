...
File frame;
File temp;
bool current_letter_done= false;
char *(letters)[256];
...
void loop() {
  ...
  parse_message("18-11-2019");
  delay(500);
  
  parse_message("happy birthday to one of the nicest people i have ever met");

  delay(1500);

  parse_message("happy birthday enas");
  delay(200);
